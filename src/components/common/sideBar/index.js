...
class Sidebar extends Component {
    ...
    onHoverAsideToggleHandler = () => {
        this.setState({
            onHoverAside: !this.state.onHoverAside
        })
        this.props.onHoverHandler();
    }

    sideBarWidthButtonToggleHandler = () => {
        this.asideToggleHandler();
        this.props.sidebarWidthToggleHandler();
    }
                ...
                <div className={`hidden lg:block aside w-64 ${this.state.asideToggle ? "minor-width" : "full-width"} ${this.state.onHoverAside ? "aside-minimze-hover" : ""}`}>   
                    <div className={`aside aside-bg md:fixed w-64 top-0 bottom-0 left-0 ${this.state.asideToggle ? "minor-width" : "full-width"} ${this.state.onHoverAside ? "aside-minimze-hover" : ""}`}>
                        <div className="brand flex shadow-none justify-between items-center	flex-row h-16 aside-logo-bg pt-0 pb-0 pl-6 pr-6">
                            ...
                            <button className="brand-toggle" onClick={this.sideBarWidthButtonToggleHandler}>
                                <span className="svg-icon svg-icon-xl">
                                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g id="Stockholm-icons-/-Navigation-/-Angle-double-left" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                            <polygon id="Shape" points="0 0 24 0 24 24 0 24"></polygon>
                                            <path className="icon-dark" d="M5.29288961,6.70710318 C4.90236532,6.31657888 4.90236532,5.68341391 5.29288961,5.29288961 C5.68341391,4.90236532 6.31657888,4.90236532 6.70710318,5.29288961 L12.7071032,11.2928896 C13.0856821,11.6714686 13.0989277,12.281055 12.7371505,12.675721 L7.23715054,18.675721 C6.86395813,19.08284 6.23139076,19.1103429 5.82427177,18.7371505 C5.41715278,18.3639581 5.38964985,17.7313908 5.76284226,17.3242718 L10.6158586,12.0300721 L5.29288961,6.70710318 Z" id="Path-94" fill="#000000" fillRule="nonzero" transform="translate(8.999997, 11.999999) scale(-1, 1) translate(-8.999997, -11.999999) "></path>
                                            <path className="icon-light" d="M10.7071009,15.7071068 C10.3165766,16.0976311 9.68341162,16.0976311 9.29288733,15.7071068 C8.90236304,15.3165825 8.90236304,14.6834175 9.29288733,14.2928932 L15.2928873,8.29289322 C15.6714663,7.91431428 16.2810527,7.90106866 16.6757187,8.26284586 L22.6757187,13.7628459 C23.0828377,14.1360383 23.1103407,14.7686056 22.7371482,15.1757246 C22.3639558,15.5828436 21.7313885,15.6103465 21.3242695,15.2371541 L16.0300699,10.3841378 L10.7071009,15.7071068 Z" id="Path-94" fill="#000000" fillRule="nonzero" opacity="0.3" transform="translate(15.999997, 11.999999) scale(-1, 1) rotate(-270.000000) translate(-15.999997, -11.999999) "></path>
                                        </g>
                                    </svg>
                                </span>
                            </button>
                        ...
                        <div onMouseEnter={this.onHoverAsideToggleHandler} onMouseLeave={this.onHoverAsideToggleHandler} className="aside-menu-wrapper">
                            <div className="aside-menu mt-4 mb-4">
                                <ul className="menu-nav py-4 px-0 m-0 list-none">
                                    ...
                                    <li className="menu-item">
                                        <Link to="/table" className="h-11 py-2 px-6 text-sm font-normal leading-7 text text-gray-500 hover:bg-gray-900 inline-flex items-center w-full hover:text-white transition-colors">
                                            <span className="svg-icon menu-icon mr-2">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g id="Stockholm-icons-/-Home-/-Library" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                        <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                            ...
                                            <span className="menu-item-li">Tables</span>
                                        </Link>
                                    </li>
